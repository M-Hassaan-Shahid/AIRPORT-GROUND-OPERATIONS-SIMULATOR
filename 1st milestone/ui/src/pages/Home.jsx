...
export default function Home() {
  const { layouts, navigateTo, addLayout, duplicateLayout, deleteLayout, theme, toggleTheme } = useApp();

  const handleCreateNew = () => {
    // Navigate to builder without creating a layout yet (lazy creation)
    navigateTo('pathBuilder', null);
  };
  ...
  return (
    <div className="home">
      <div className="home-header">
        ...
        <button className="btn btn-secondary btn-icon" onClick={toggleTheme} title={`Switch to ${theme === 'dark' ? 'light' : 'dark'} mode`}>
